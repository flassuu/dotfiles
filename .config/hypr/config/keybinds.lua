...
hl.bind(mainMod .. " + SHIFT + CTRL + up",    hl.dsp.exec_cmd(string.format(MOVE_ACTIVE, 0,   -30, "u")), { repeating = true, description = "Move activewindow up" })
hl.bind(mainMod .. " + SHIFT + CTRL + down",  hl.dsp.exec_cmd(string.format(MOVE_ACTIVE, 0,   30,  "d")), { repeating = true, description = "Move activewindow down" })
